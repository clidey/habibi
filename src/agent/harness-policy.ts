const WRITE_VERBS =
  /(?:send|create|update|delete|write|schedule|modify|archive|invite|pay|purchase)/i;
...
export type ToolPolicyDecision =
  { decision: 'allow' } | { decision: 'require_confirmation'; reason: string };
